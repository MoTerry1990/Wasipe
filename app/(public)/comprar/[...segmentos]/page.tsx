...
/**
 * Búsqueda con la dirección bonita: /comprar/departamento/miraflores.
 *
...
export async function generateMetadata({ params, searchParams }: Props): Promise<Metadata> {
  ...
  return metadatosDeBusqueda('sale', combinados);
}

export default async function ComprarPorSegmentos({ params, searchParams }: Props) {
  const { segmentos } = await params;
  const combinados = comoParametros(segmentos, await searchParams);
  ...
  return <PaginaDeBusqueda operacion="sale" params={combinados} />;
}
